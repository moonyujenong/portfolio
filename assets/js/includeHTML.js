window.addEventListener('DOMContentLoaded', function() {
    function includeHTML(container) {
        var allElements = container.querySelectorAll('[data-include-path]');
            ...
            if (includePath) {
                ...
                xhttp.onreadystatechange = function () {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        scripts.filter(function (node) {
                            return node.type.toLowerCase() == 'text/javascript' || node.type.toLowerCase() == 'application/javascript';
